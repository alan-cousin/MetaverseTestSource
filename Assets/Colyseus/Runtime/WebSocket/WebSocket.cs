...
namespace NativeWebSocket
{
    ...
    public class WebSocket : IWebSocket {
        ...
        public static extern int WebSocketConnect_cls(int instanceId);

        [DllImport("__Internal")]
        public static extern int WebSocketClose_cls(int instanceId, int code, string reason);

        [DllImport("__Internal")]
        public static extern int WebSocketSend_cls(int instanceId, byte[] dataPtr, int dataLength);

        [DllImport("__Internal")]
        public static extern int WebSocketSendText_cls(int instanceId, string message);

        [DllImport("__Internal")]
        public static extern int WebSocketGetState_cls(int instanceId);
        ...
        if (!WebSocketFactory.isInitialized) {
            ...
            int instanceId = WebSocketFactory.WebSocketAllocate_cls(url);
            WebSocketFactory.instances.Add(instanceId, this);
            Debug.Log("WebSocket Constructor:" + instanceId);
        ...
        public Task Connect() {
            int ret = WebSocketConnect_cls(this.instanceId);
            if (ret < 0)
        ...
        public Task Close(WebSocketCloseCode code = WebSocketCloseCode.Normal, string reason = null) {
            int ret = WebSocketClose_cls(this.instanceId, (int)code, reason);
        ...
        public Task Send(byte[] data) {
            int ret = WebSocketSend_cls(this.instanceId, data, data.Length);
        ...
        public Task SendText(string message) {
            int ret = WebSocketSendText_cls(this.instanceId, message);
        ...
        public WebSocketState State {
            get {
                int state = WebSocketGetState_cls(this.instanceId);
        ...
        public void DelegateOnCloseEvent(int closeCode) {
            Debug.Log("Check DelegateOnCloseEvent");
    ...
    [DllImport ("__Internal")]
    public static extern int WebSocketAllocate_cls (string url);

    [DllImport ("__Internal")]
    public static extern void WebSocketFree_cls (int instanceId);

    [DllImport ("__Internal")]
    public static extern void WebSocketSetOnOpen_cls (OnOpenCallback callback);

    [DllImport ("__Internal")]
    public static extern void WebSocketSetOnMessage_cls (OnMessageCallback callback);

    [DllImport ("__Internal")]
    public static extern void WebSocketSetOnError_cls (OnErrorCallback callback);

    [DllImport ("__Internal")]
    public static extern void WebSocketSetOnClose_cls (OnCloseCallback callback);
    ...
    public static void Initialize () {
      ...
      WebSocketSetOnOpen_cls (DelegateOnOpenEvent);
      WebSocketSetOnMessage_cls (DelegateOnMessageEvent);
      WebSocketSetOnError_cls (DelegateOnErrorEvent);
      WebSocketSetOnClose_cls (DelegateOnCloseEvent);
