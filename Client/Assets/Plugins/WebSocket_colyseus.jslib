...
var LibraryWebSocket = {
	 ...
	 */
	WebSocketSetOnOpen_cls: function(callback) {
        console.log("Check WebSocketSetOnOpen");
	 ...
	 * @param callback Reference to C# static function
	 */
	WebSocketSetOnMessage_cls: function(callback) {
		console.log("Check WebSocketSetOnMessage");
	 ...
	 * @param callback Reference to C# static function
	 */
	WebSocketSetOnError_cls: function(callback) {
console.log("WebSocketSetOnError");
	 ...
	 * @param callback Reference to C# static function
	 */
	WebSocketSetOnClose_cls: function(callback) {
		console.log("WebSocketSetOnClose");
	 ...
	 */
	WebSocketAllocate_cls: function(url) {
		console.log("Check WebSocketAllocate");
	 ...
	 */
	WebSocketFree_cls: function(instanceId) {
		console.log("Check WebSocketFree");
	 ...
	 * @param instanceId Instance ID
	 */
	WebSocketConnect_cls: function(instanceId) {
       console.log("Check colyseus WebSocketConnect");
	 ...
	 */
	WebSocketClose_cls: function(instanceId, code, reasonPtr) {
console.log("WebSocketClose");
	 ...
	 */
	WebSocketSend_cls: function(instanceId, bufferPtr, length) {
	 ...
	 * @param length Length of the message in the buffer
	 */
	WebSocketSendText_cls: function(instanceId, message) {
	 ...
	 * @param instanceId Instance ID
	 */
	WebSocketGetState_cls: function(instanceId) {
