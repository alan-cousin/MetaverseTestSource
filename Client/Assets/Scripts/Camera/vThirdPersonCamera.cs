...
public class vThirdPersonCamera : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyUp(KeyCode.V) && MainBody.transform.parent.gameObject.GetComponent<CharacterColiderControl>().stateFlag)
        {
            if (m_bTPCam = !m_bTPCam)
                FirstCharactorControl();
            else
                ThirdCharactorControl();
        }
    }
    void FixedUpdate()
    {
    ...
    void CameraMovement()
    {
        ...
        if (!MainBody.transform.parent.gameObject.GetComponent<CharacterColiderControl>().stateFlag)
        {
            CameraFollowStop();
            return;
        }
    ...
    void CameraFollowStop()
    {
        ...
        currentTarget = MainBody.transform.parent.GetComponent<CharacterColiderControl>().interactObj.transform;
